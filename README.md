...
The database file `netflix_app.db` is created automatically.
...
For real deployment, replace SQLite with PostgreSQL so all users share the same persistent database.
